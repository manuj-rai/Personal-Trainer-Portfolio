  ...
  constructor() {
    ...
    const initialServices: InsertService[] = [
      ...
      },
      {
        ...
        price: "$30/session",
        features: ["Fun atmosphere", "Team motivation", "Varied exercises"]
      },
      {
        title: "Online Coaching",
        description: "Remote training with expert guidance",
        price: "$199/month",
        features: ["24/7 support", "Video form checks", "Custom meal plans"]
      }
    ];
    ...
    const initialTestimonials: InsertTestimonial[] = [
      ...
      {
        name: "Mike Peters",
        text: "The group sessions are incredible. Great energy and results!",
        rating: 5,
